...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed top-0 w-full h-full bg-gray-200 bg-opacity-30 first-letter: backdrop-blur-sm flex items-center justify-center font-sans "
      onClick={close}
    >
      <div
        className="w-[65%] h-[75%] bg-gray-300 bg-opacity-75 rounded-lg text-white relative xs:w-[85%] xs:h-[95%] md:w-[95%] md:h-[95%]"
        onClick={(e) => e.stopPropagation()}
      >
        {data ? (
          <div className="flex items-center justify-between h-full w-full p-4 xs:flex-wrap ">
            <div className="flex flex-col w-[45%] h-full pr-2 xs:w-full xs:flex-wrap xs:h-[50%]">
              <div className="flex w-full items-center">
                <img
                  className="w-[3rem] h-[3rem] mx-1.5 xs:w-[1rem] xs:h-[1rem]"
                  src={data.image.large}
                  alt={data.id}
                />
                <h1 className="text-xl capitalize font-medium xs:text-sm">
                  {data.name}
                </h1>
                <span className=" text-sm py-0.5 px-2.5 ml-2 bg-cyan text-cyan bg-opacity-25 rounded uppercase xs:px-0.5 xs:text-xs">
                  {data.symbol}
                </span>
              </div>
              <div className="flex w-full mt-6">
                <div className="flex flex-col w-full">
                  <div className="flex justify-between">
                    <span className="text-sm px-1 capitalize text-gray-100 xs:text-xs">
                      Price
                    </span>
                    <div
                      className={`text-sm px-1 ml-2 font-medium flex items-center rounded uppercase bg-opacity-25 xs:text-xs ${
                  ...
                  <h2 className="text-lg font-bold xs:text-xs">
              ...
              <div className="flex w-full mt-4 justify-between xs:mt-1">
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100 xs:text-xs">
                    Market Cap
                  </span>
                  <h2 className="text-base font-bold xs:text-xs">
                    {new Intl.NumberFormat("en-IN", {
                      style: "currency",
                      currency: currency,
              ...
              <div className="flex flex-col w-full mt-4 justify-between xs:mt-1">
                <span className="text-sm capitalize text-gray-100 xs:text-xs">
                  Total Volume
                </span>
                <h2 className="text-base font-bold xs:text-xs">
              ...
              <div className="flex w-full mt-4 justify-between xs:mt-0">
                <div className=" flex flex-col">
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    className="text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded xs:text-xs xs:px-0 xs:my-0 "
                  ...
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    className="text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded xs:text-xs xs:px-0 xs:my-1 "
                ...
                <div className="flex flex-col content-start">
                  <span className="text-sm capitalize text-gray-100 xs:text-sm xs:px-0">
                    Sentiment
                  </span>
                  <div
                    className={`text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 xs:text-xs xs:px-0   bg-green text-green`}
                  >
                    <span>
                  ...
                  <div>
                    <div className="flex flex-col content-start">
                      <div
                        className={`text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 xs:text-xs bg-red text-red`}
                      >
                        <span>
            ...
            <div className="flex flex-col w-[55%] h-full pl-3 xs:w-full xs:h-[55%]  xs:pl-1 ">
              <Chart id={data.id} />
              <div className="flex flex-col mt-4">
                <h3 className="text-white py-1 xs:text-xs">
                  <span className="text-gray-100 mr-1 capitalize ">
                    Market Cap rank :{" "}
                  </span>
              ...
              <div className="absolute bottom-8 right-8 flex items-center xs:right-11">
                {data.links.repos_url.github[0] && (
                  <a
                    className="text-lg px-1 xs:text-sm"
                    target={"_blank"}
                    rel="noreferrer"
