...
const Trending = (data) => {
  ...
  return (
    <section className='w-[80%] h-full flex flex-col mt-16 mb-24 relative xs:w-[90%]'> 
    <div className='w-full min-h-[60vh] py-8 flex flex-wrap justify-evenly  border border-gray-100 rounded xs:flex-col '>
{
